        ...
        <motion.div {...fadeUp} transition={{ delay: 0.1 }}>
            <SpotlightCard className="p-5">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="bg-[#F97316] text-white text-[11px] font-extrabold rounded-full w-6 h-6 flex items-center justify-center shadow-[0_2px_8px_rgba(249,115,22,0.4)]">12</span>
                </div>
                <div className="flex flex-col">
                    {dueReviewItems.slice(0, 2).map(item => (
                        <div key={item.id} className="flex items-center gap-3 py-2.5 border-b border-white/5 cursor-pointer hover:bg-white/[0.04] rounded-lg -mx-1.5 px-1.5 transition-colors">
